...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="border-gray-200 border rounded-xl p-5 mb-10">
        ...
        {atividades.length === 0 ? (
          <div className="flex flex-col items-center">
            <p className="mb-4">
              Parece que você ainda não inicou nenhum atividade. Vamos lá!
            </p>
            <button className="bg-sky-900 text-white text-sm py-2 px-3 rounded-lg">
              Inicie uma atividade nova
            </button>
          </div>
        ) : (
          <div className="flex">
      ...
      <div>
        <p className="text-lg font-semibold mb-5 ml-3">
          Inicie uma nova unidade
        </p>
