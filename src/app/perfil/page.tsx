  ...
  return (
    <div>
        ...
        <div className="flex items-center">
          ...
          <div>
            <p className="font-bold text-lg">
              {users_data[0].nome} {users_data[0].sobrenome}
            </p>
            <a
              href=""
      ...
      <div className="flex justify-between mb-10">
        <div className="border-gray-200 border rounded-xl p-5 w-full">
          ...
          <div className="flex relative items-center">
            ...
            <p className="mx-auto w-1/3 text-center">
              Você concluiu 9 de 10 unidades.
            </p>
          </div>
        </div>
        <div className="border-gray-200 border rounded-xl p-5 w-full ml-5 flex flex-col justify-between">
          ...
          <div className="flex">
            ...
            <p className="text-center">
              Você está entre os 3 melhores em 6 unidades diferentes. Continue
              assim!
            </p>
          </div>
          <button className="bg-sky-950 text-white w-full rounded-md p-2">
            Ver ranking
          </button>
        </div>
        <div className="border-gray-200 border rounded-xl p-5 w-full ml-5 grid">
          ...
          <p className="text-center justify-self-center">
            Complete todas as atividades para realizar uma prova e emitir o seu
            certificado.
          </p>
        </div>
      </div>
      <div className="border-gray-200 border rounded-xl p-5">
        ...
        <AchievementCard
          title="Jogador ativo"
          description="Faça login por 7 dias."
          progress={5}
          image="aa"
        />
        <AchievementCard
